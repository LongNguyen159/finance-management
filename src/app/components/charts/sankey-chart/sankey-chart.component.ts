...
import { SankeyData, SYSTEM_PREFIX } from '../../models';
...
export class SankeyChartComponent extends BaseChartComponent implements OnChanges {
  ...
  //       } else {
  //         this.uiService.showSnackBar(`You are not allowed to modify this entry, since it's generated by the system.`, 'Close', 5000)
  //       }
  //     }
  //   });
  // }
