...
export class DataService {
    ...
    demoLinks: UserDefinedLink[] = [
        { type: EntryType.Income, target: 'Salary demo', value: 2200, demo: true, isFixCost: true },
        { type: EntryType.Expense, target: 'Rent', value: 550, source: ExpenseCategory.Housing, isFixCost: true },
        { type: EntryType.Expense, target: 'WiFi', value: 40, source: ExpenseCategory.Utils, isFixCost: true},
        { type: EntryType.Expense, target: 'Gas', value: 300, source: ExpenseCategory.Commute},
        { type: EntryType.Expense, target: 'Parking', value: 100, source: ExpenseCategory.Commute},
        { type: EntryType.Expense, target: 'Car warranty', value: 100, source: ExpenseCategory.Commute, isFixCost: true},
